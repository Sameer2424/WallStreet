...
for squad_id in squadids:
    ...
    for player_id in player_ids:
        ...
        tablerow.extend([player_id, name, full_name, dob, pob, playing_role, batting_style, bowling_style])
        ...
        if parsed_html.find('table', class_='engineTable'):
            ...
            bowling = [td.text.strip() for td in parsed_html.findAll('table', class_='engineTable')[1].findAll('td')]
        ...
        conn = psycopg2.connect(database="ebdb", user="postgres", password="Champ2424", host="aa1rgau2058nibn.ciqodeqxwwle.us-west-1.rds.amazonaws.com", port="5432")
        cursor = conn.cursor()
