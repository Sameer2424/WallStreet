...
function callWatchlistAPI(){
	...
	$.getJSON(url, function (data) {
		...
		for (i=0; i < data.stocks.length ; i++) {
			var watchlistHtmlContent = "<a class='openOrderModal'"+	
				 "data-company='{companyID}'"+
				 "data-url='/market/create-order/'>"+
...
$(document).ready(function () {
	...
	var dividerHtml = "<optgroup label='----------'></optgroup>";
	var plusBtn = "<button type='button' class='add-row'><span aria-hidden='true'>+</span></button>"
	document.getElementById('stocks_watchlist').innerHTML += dividerHtml;
	document.getElementById('stocks_watchlist').innerHTML += plusBtn;
