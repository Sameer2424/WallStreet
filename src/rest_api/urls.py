...
urlpatterns = [
    ...
    url(r"^activate-user/", ActivateUserAPIView.as_view(), name="activate_user"),
    url(r"^login/", LoginView.as_view(), name="login"),
    url(r"^loginwp/", LoginWithoutPasswordView.as_view(), name="loginwp"),
    ...
    url(r"^get-followers/", GetUserFollowers.as_view(), name="get_followers"),
    url(r"^get-following/", GetUserFollowing.as_view(), name="get_following"),
]
